...
export const aiWork: WorkItem[] = [
  {
    ...
    summary:
      "Designing how a team builds with AI agents — the conventions, guardrails, and structure that make agentic development reliable instead of chaotic.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "Building multi-step, mostly-autonomous workflows — review, admin, and research pipelines — that run with a human in the loop where it matters.",
    highlights: [
